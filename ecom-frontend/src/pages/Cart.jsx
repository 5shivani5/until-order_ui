...
export default function Cart() {
  ...
  const handleClear = async () => {
   ...
   const handleCheckout = () => {
      navigate("/payment", { state: { amount: grand, items: items } }); // send total + items
    };
                ...
                <div key={item.productId} style={styles.card}>
                  <div style={styles.cardLeft}>
                    {item.imageUrl ? (
                      ...
                      <div style={{ ...styles.image, background: "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}>👗</div>
                    )}
